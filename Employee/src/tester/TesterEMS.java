...
//						sc.useDelimiter("\\n");
						...
						Employees ref = validateAllInputs(EmpType.FTE, sc.next(), sc.next(), sc.next(), sc.next(),
								eMap);
					...
					case 2:
						...
						System.out.println("Enter Name, Date Of Joining(yyyy-mm-dd), Phone, AadharNo(XXXX-XXXX-XXXX):");
						Employees ref2 = validateAllInputs(EmpType.PTE, sc.next(), sc.next(), sc.next(), sc.next(),
								eMap);
					...
					case 4:
						...
						Employees searchedAadharNo = searchByAadharNo(sc.next(), eMap);
